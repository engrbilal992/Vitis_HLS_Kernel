...
proc getTraceEvents {kernelName cuName moduleName signal targetValue {requireEnd 0}} {
  ...
  set startTimeMsec 0
  set factor 9.0
  set currDeviceName xilinx_u200_gen3x16_xdma_2_202110_1-0
  set currBinaryName fpgabinary.hw_emu
...
# Compute Unit Stalls
#
set computeUnits { scalar_mult_1 }
set cuFullPaths { /pfm_top_wrapper/pfm_top_i/pfm_dynamic_inst/scalar_mult_1/inst/ }
